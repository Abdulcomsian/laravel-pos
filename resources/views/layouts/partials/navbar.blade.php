    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <img src="https://dreamspos.dreamguystech.com/html/template/assets/img/icons/notification-bing.svg" alt="">
      ...
      <li class="nav-item dropdown has-arrow main-drop">
        <a>
          <div class="user__img">
            <img src="{{asset('images/avator1.jpeg')}}" alt="">
        ...
        <div class="profilename">
          <div class="profileset">
            <span class="user__img"><img src="{{asset('images/avator1.jpeg')}}" alt="">
            ...
            <hr class="m-0">
            <a class="dropdown-item logout pb-0" href="signin.html"><img src="https://dreamspos.dreamguystech.com/html/template/assets/img/icons/log-out.svg" style="margin-right: 10px;" alt="img">Logout</a>
          </div>
        </div>
      </li>
    </ul>
